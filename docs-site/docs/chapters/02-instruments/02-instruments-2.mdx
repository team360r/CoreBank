---
sidebar_position: 2
slug: /chapters/instruments/part-2
title: "Reading the Instruments — Part 2"
description: "Make the login interactive, add account selection with state, and learn why keys matter in lists."
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Reading the Instruments — Part 2
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('FlightBank')),
...
- [Widget lifecycle — flutter.dev](https://docs.flutter.dev/ui/interactivity/lifecycle)
- [When to use keys — Flutter article](https://medium.com/flutter/keys-what-are-they-good-for-13cb51742e7d)
- [State management intro — flutter.dev](https://docs.flutter.dev/data-and-backend/state-mgmt/intro)

---

## What's Next

In Chapter 3 you will connect your screens with GoRouter, Flutter's recommended routing package. You will set up named routes, pass parameters between screens, and add redirect guards so unauthenticated users cannot access the accounts page.
