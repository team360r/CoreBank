...
```mermaid
graph TD
  A["CoreBankApp (holds themeMode)"] --> B["HomeScreen"]
  B --> C["AccountsScreen"]
...
### Step 3: Convert CoreBankApp to ConsumerWidget
